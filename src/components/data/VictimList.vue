<template>
    <div class="w-[35%]">
        Victim Filter:
        <input type="text" placeholder="Filter here. eg. github.com" @input="loadVictims" v-model="filter" class="rounded-md mb-6 w-full border-slate-300">
    </div>
...
export default {
    ...
    methods: {
        loadVictims: _.debounce(function() {
